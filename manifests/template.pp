...
#   Value type is string
#   Default value inherited from elasticsearch_old::api_protocol: http
#   This variable is optional
#
# [*api_host*]
#   Host name or IP address of the ES instance to connect to
#   Value type is string
#   Default value inherited from $elasticsearch_old::api_host: localhost
#   This variable is optional
#
# [*api_port*]
#   Port number of the ES instance to connect to
#   Value type is number
#   Default value inherited from $elasticsearch_old::api_port: 9200
#   This variable is optional
#
# [*api_timeout*]
#   Timeout period (in seconds) for the Elasticsearch API.
#   Value type is int
#   Default value inherited from elasticsearch_old::api_timeout: 10
#   This variable is optional
#
...
#   API.
#   Value type is String
#   Default value inherited from elasticsearch_old::api_basic_auth_username: undef
#   This variable is optional
#
...
#   API.
#   Value type is String
#   Default value inherited from elasticsearch_old::api_basic_auth_password: undef
#   This variable is optional
#
# [*api_ca_file*]
...
#   Value type is String
#   Default value inherited from elasticsearch_old::api_ca_file: undef
#   This variable is optional
#
# [*api_ca_path*]
...
#   Value type is String
#   Default value inherited from elasticsearch_old::api_ca_path: undef
#   This variable is optional
#
# [*validate_tls*]
...
#   Default value inherited from elasticsearch_old::validate_tls: true
#   This variable is optional
#
# === Authors
#
...
define elasticsearch_old::template (
  ...
  $source                  = undef,
  $content                 = undef,
  $api_protocol            = $elasticsearch_old::_api_protocol,
  $api_host                = $elasticsearch_old::api_host,
  $api_port                = $elasticsearch_old::api_port,
  $api_timeout             = $elasticsearch_old::api_timeout,
  $api_basic_auth_username = $elasticsearch_old::_api_basic_auth_username,
  $api_basic_auth_password = $elasticsearch_old::_api_basic_auth_password,
  $api_ca_file             = $elasticsearch_old::api_ca_file,
  $api_ca_path             = $elasticsearch_old::api_ca_path,
  $validate_tls            = $elasticsearch_old::_validate_tls,
) {
  validate_string(
    $api_protocol,
    $api_host,
  ...
  es_instance_conn_validator_old { "${name}-template":
    server => $api_host,
    port   => $api_port,
  } ->
  elasticsearch_old_template { $name:
    ensure       => $ensure,
    content      => $_content,
    source       => $_source,
